...
Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -match "SagarSystemHealthMonitor.*server\.py" -or $_.CommandLine -match "SERVER_WATCHDOG_2278\.ps1" } | ForEach-Object { Stop-Process -Id $_.ProcessId -Force -ErrorAction SilentlyContinue }
