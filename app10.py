            ...
            if filename.endswith(".log") and filename != "wan_speed.json":
                ...
                with open(filepath, "r") as f:
                    try:
                        ...
                        # FIXED INTERFACE LOOKUPS FOR LINUX ENDPOINTS
                        day_rx_val = history.get("daily_rx_bytes", 0)
                        if day_rx_val == 0: day_rx_val = raw_rx
                        
                        day_tx_val = history.get("daily_tx_bytes", 0)
                        if day_tx_val == 0: day_tx_val = raw_tx
