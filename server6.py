                ...
                with open(filepath, "r") as f:
                    try:
                        ...
                        rows.append({
                            ...
                            "IP Addresses": filename.replace(".log", ""),
                            "_raw_mtime": last_mod
                        })
    ...
    try:
        ...
        for host, info in devices.items():
            export_list.append({
                ...
                "CPU Name": info.get("cpu_name", "N/A"),
                "CPU Serial ID": info.get("cpu_id_serial", "N/A"),
                "Total RAM (GB)": info.get("ram_total_gb", "N/A"),
                "MAC Address(es)": info.get("mac_addresses", "N/A"),
                "Primary GPU": info.get("gpu_name", "N/A"),
                "Connected Peripherals": info.get("peripherals_list", "N/A")
            })
